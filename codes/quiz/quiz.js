...
const i18n_text = {
  zh: {
    ...
    overview_title: "测验流程总览",
    overview_tip: "先选难度，再逐题提交，最后查看本关结果。",
    cta_start_quiz: "开始答题",
    cta_to_game: "前往游戏",
    quick_title: "快速操作",
    quick_desc: "如果你想先复习规则，再回主页浏览图形演示后继续测验。",
    status_kicker: "Quiz Status",
    status_title: "进度与得分",
    status_desc: "在下方答题区实时查看当前关卡进度和累计得分。",
    cta_continue: "继续作答",
    back_home: "返回主页",
    level_title: "选择难度",
    ...
    footer_text: "EBU5315 Group 17 · Circle Geometry Quiz Route"
  },
  en: {
    ...
    overview_title: "Quiz Flow Overview",
    overview_tip: "Choose a level, submit each answer, and check your result at the end.",
    cta_start_quiz: "Start Quiz",
    cta_to_game: "Go to Game",
    quick_title: "Quick Action",
    quick_desc: "Need a quick review first? Return to homepage and then continue the quiz.",
    status_kicker: "Quiz Status",
    status_title: "Progress and Score",
    status_desc: "Track your level progress and cumulative score in the quiz panel below.",
    cta_continue: "Continue Quiz",
